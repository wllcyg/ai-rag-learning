...
在 [`src/pipeline/pipeline.types.ts`](file:///Users/moliang/Desktop/coder/ai-rag-learning/src/pipeline/pipeline.types.ts) 中定义了管线流转的标准数据结构：
...
文件位置：[`src/pipeline/chunking.service.ts`](file:///Users/moliang/Desktop/coder/ai-rag-learning/src/pipeline/chunking.service.ts)
...
文件位置：[`src/pipeline/embedding.service.ts`](file:///Users/moliang/Desktop/coder/ai-rag-learning/src/pipeline/embedding.service.ts)
...
文件位置：[`src/pipeline/vector-index.service.ts`](file:///Users/moliang/Desktop/coder/ai-rag-learning/src/pipeline/vector-index.service.ts)
...
文件位置：[`src/pipeline/pipeline.orchestrator.ts`](file:///Users/moliang/Desktop/coder/ai-rag-learning/src/pipeline/pipeline.orchestrator.ts)
