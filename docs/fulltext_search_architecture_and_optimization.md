...
目前系统的实现逻辑如下：
1. **生产者（[`DocumentPipelinePublisher`](https://github.com/wllcyg/ai-rag-learning/blob/main/src/mq/document-pipeline.publisher.ts)）**：
...
2. **消费者（[`DocumentPipelineConsumer`](https://github.com/wllcyg/ai-rag-learning/blob/main/src/mq/document-pipeline.consumer.ts)）**：
